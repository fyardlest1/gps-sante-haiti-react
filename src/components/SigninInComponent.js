...
import {Col, Breadcrumb, BreadcrumbItem, Form, FormGroup, 
                      ...
                      >
                        ...
                        <div className='col'>
                          <form action className='formGroup' id='formGroup'>
                            ...
                            <a
                              href='reset-password-account.html'
                              className='form-text text-center text-primary font-weight-bold'
                            >
                            ...
                            <div className='form-group row'>
                              <div className='col-6'>
                                <a
                                  href='#'
                                  className='btn btn-social btn-md btn-google form-control'
                                >
                              ...
                              <div className='col-6'>
                                <a
                                  href='#'
                                  className='btn btn-social btn-md btn-facebook form-control'
                                >
