          ...
          <div className="col-md-3 mb-3">
            <Card className='border-primary text-center text-white'>
              <CardBody className="card-body">
                <img src="/assets/images/person1.jpg" width="60%" className="rounded-circle" />
                <h3 className="text-primary">Good Care</h3>
                <p className="text-muted">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Repudiandae, dolore.</p>
                <a href="#" className="btn btn-dark mx-auto">En savoir Plus</a>
              </CardBody>
            </Card>
          </div>
          <div className="col-md-3 mb-3">
            <Card className="card bg-info text-center text-white">
              <CardBody className="card-body">
                ...
                <a href="#" className="btn btn-light mx-auto">En savoir Plus</a>
              </CardBody>
            </Card>
          </div>
          <div className="col-md-3 mb-3">
          ...
          <div className="row pb-3">
            <div className="col text-center">
              ...
              <p className="latestPost">
                Soyez toujours au courant des dernièrs nouvelles et recevez des infos concernant les médecins et services à votre disposition.
              </p>
              <form className="form-inline justify-content-center">
                <input type="text" className="form-control mb-2 mr-2" placeholder="Votre Nom" />
                <input type="email" className="form-control mb-2 mr-2" placeholder="Votre Email" />
                <button type="submit" className="btn btn-secondary mb-2">
                  <i className="fa fa-envelope-open" /> Souscrire</button>
              </form>
            </div>
          </div>
        </div>
