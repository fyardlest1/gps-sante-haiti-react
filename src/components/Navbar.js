            ...
            <Navbar className="navbar navbar-expand-md navbar-dark sticky-top">
                <div className="container">
                    <NavbarBrand className="col d-none d-md-block navbar-brand">
                        <img src='assets/images/mlogo.png' width="50" height="50" alt="Site Logo" className="img-fluid" />
                    </NavbarBrand>
                    ...
                    <Nav navbar>
                        ...
                        <NavItem>
                            <NavLink className='nav-link' to='/contactus'>Log In
                            </NavLink>
                        </NavItem>

                        <NavItem>
                            <NavLink className='nav-link' to='/addyours'>Ajouter
                            </NavLink>
                        </NavItem>

                        <NavItem>
                            <NavLink className='nav-link' to='/ourshop'> Shop
                            </NavLink>
                        </NavItem>

                    </Nav>
                    <form className="col-md-4 input-group ml-auto">
                        <input type="text" className="form-control d-inline mr-2" placeholder="Trouver un Medecin" />
